...
public class TreesType extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("TreesType");


        // On précise les classes MyProgram, Map et Reduce

        job.setJarByClass(TreesType.class);

        job.setMapperClass(TreesTypeMapper.class);

        job.setReducerClass(TreesTypeReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        TreesType exempleDriver = new TreesType();
